...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u2 = new User(null, "Alex Green", "alex@gmail.com", "977777777", "456789");
		User u3 = new User(null, "John White", "john@gmail.com", "977775622", "658479");
		...
		Order o5 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.CANCELED, u3);
		Order o6 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.SHIPPED, u2);
		Order o7 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.PAID, u2);
